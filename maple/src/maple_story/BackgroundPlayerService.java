...
public class BackgroundPlayerService implements Runnable {
	...
	public void run() {
		while (true) {
			Color bottomColor = new Color(image.getRGB(mContext.getCharacter().getX() + 40, mContext.getCharacter().getY() + 95));
			Color bottomColorLeft = new Color(image.getRGB(mContext.getCharacter().getX() , mContext.getCharacter().getY() + 95));
			Color bottomColorRight = new Color(image.getRGB(mContext.getCharacter().getX() + 70, mContext.getCharacter().getY() + 95));
